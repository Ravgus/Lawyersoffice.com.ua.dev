 ...
 * Class Dtp
 *
 * @property \App\Dtp $model
 *
 * @see http://sleepingowladmin.ru/docs/model_configuration_section
 */
class Dtp extends Section implements Initializable
{
    protected $model = '\App\Dtp';
    /**
    ...
    {
        $this->addToNavigation()->setIcon('fa fa-ambulance')->setPriority(200);
    }
