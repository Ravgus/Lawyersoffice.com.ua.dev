                            ...
                            <fieldset>
                                <div class="form-group <?=($errors->has('username')) ? 'has-error' : ''?>">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control"
                                           placeholder="{{ trans('sleeping_owl::lang.auth.username') }}" autofocus/>
                                </div>
                                <div class="form-group <?=($errors->has('password')) ? 'has-error' : ''?>">
                                    {!! $errors->first('password', '<label for="password" class="control-label">:message</label>') !!}
                                    <input type="password" name="password" id="password" class="form-control"
                                           placeholder="{{ trans('sleeping_owl::lang.auth.password') }}"/>
                                </div>
                                <input type="submit" value="{{ trans('sleeping_owl::lang.auth.login') }}"
